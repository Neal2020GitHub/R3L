...
FLOOR_PLAN_PROMPT = """You are an experienced room designer. Please assist me in crafting a floor plan. Each room is a rectangle, defined by its four corner coordinates.
...
First, use natural language to explain your high-level design strategy and layout criteria, then follow the desired JSON format *strictly* (do not add any additional text at the beginning or end).

For example, again consider the "living room of an architect", then your response should start with: 

"The room should be anchored by a dominant seating arrangement, creating a primary functional zone. This zone is balanced by purposeful wall compositions, featuring both artistic elements and curated displays of professional interest, such as design books."
"""
